...
const HtmxCoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_htmxcore_free(ptr >>> 0, 1));
...
export class HtmxCore {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        HtmxCoreFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_htmxcore_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.htmxcore_new();
        this.__wbg_ptr = ret >>> 0;
        HtmxCoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    scan_dom() {
        wasm.htmxcore_scan_dom(this.__wbg_ptr);
    }
    /**
    ...
    processElement(element) {
        try {
            ...
            wasm.htmxcore_processElement(retptr, this.__wbg_ptr, addBorrowedObject(element));
