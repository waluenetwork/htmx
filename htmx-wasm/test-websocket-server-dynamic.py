#!/usr/bin/env python3
"""
Dynamic WebSocket server for testing HTMX WASM WebSocket extension
...
class HTMXWebSocketServer:
    ...
    async def register_client(self, websocket):
        ...
        welcome_msg = {
            "content": "<div class='message'>WebSocket connection established!</div>",
            "target": "#messages",
            "swap": "beforeend"
        }
